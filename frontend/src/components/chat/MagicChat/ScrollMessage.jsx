...
export default function ScrollMessage({
  ...
  return (
    <motion.div
      initial={{ opacity: 0, scale: 0.35, rotate: rotate * 2.5, y: y - 40 }}
      animate={{ opacity: 1, scale: 1, rotate, y }}
      transition={{ type: "spring", stiffness: 220, damping: 18, mass: 0.6 }}
      className="absolute"
      style={{ left: x, top: 0, width }}
    >
      {/* Landing particle puff */}
      <motion.div
        ...
        style={{
          width: 40,
          height: 40,
          background: colors.glow.lavender,
          filter: "blur(6px)",
        }}
      />
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            boxShadow: `0 14px 34px ${colors.shadow.dark}, 0 0 26px ${colors.glow.violet}`,
        ...
        >
          ...
          {firstImage && (
            <img
              src={firstImage.url}
              alt=""
              className="relative w-full max-h-40 object-cover rounded-xl mb-2"
            />
          )}

          {text && (
            <p
              className="relative text-[14px] leading-6 whitespace-pre-wrap"
          ...
          {time && (
            <div
              className="relative mt-1.5 text-[10px] text-right"
